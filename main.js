...
let constraints ={
    video:
    { //for better video quality- remove false and replace this code
...
let init = async () => {
    client = await AgoraRTM.createInstance(APP_ID)
        ...
        //creating our channel find a channel by main
...
let createAnswer=async(MemberId,offer)=>{
    ...
    client.sendMessageToPeer({text:JSON.stringify({'type':'answer','answer':answer})}, MemberId)  //send the msg to the peer with this ID
}
